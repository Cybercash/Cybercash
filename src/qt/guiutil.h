...
/** Utility functions used by the Cybercash Qt UI.
 */
namespace GUIUtil
{
...
// Render Cybercash addresses in monospace font
...
// Parse "cybercash:" URI into recipient object, return true on successful parsing
