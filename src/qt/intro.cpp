...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cybercash Core"),
     ...
     * override -datadir in the cybercash.conf file in the default data directory
     * (to be consistent with cybercashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
