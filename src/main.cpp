...
#if defined(NDEBUG)
#error "Cybercash cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 3 * 60 * 60;  //MINSTAKEAGE = 3 Hours
...
int64_t GetSubsidy(int nHeight)
{
    ...
    else if (nHeight > 719 && nHeight < 10000) {
        nSubsidy = 1 * COIN;
    } 
...
{
    RenameThread("cybercash-scriptch");
