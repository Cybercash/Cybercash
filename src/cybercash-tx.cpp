...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cybercash Core cybercash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cybercash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cybercash transaction") + "\n" +
                               "  cybercash-tx [options] -create [commands]   " + _("Create hex-encoded cybercash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cybercash transaction
