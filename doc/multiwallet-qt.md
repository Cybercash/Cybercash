...
In order to support loading of multiple wallets in cybercash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cybercash.cpp.
...
Changes to cybercash.cpp
----------------------
cybercash.cpp is the entry point into cybercash-qt, and as such, will require some minor modifications to provide hooks for
