...
*Setup instructions for a gitian build of Cybercash using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Cybercash
...
- [Building Cybercash](#building-cybercash)
...
This CYBERCASH image can be validated using a SHA256 hashing tool, for example on
...
Then start the VM. On the first launch you will be asked for a CD or CYBERCASH image. Choose the downloaded iso.
...
Clone the git repositories for cybercash and gitian and then checkout the cybercash version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/cybercash-crypto/cybercash.git
cd cybercash
...
Follow the instructions in [doc/release-process.md](release-process.md) in the cybercash repository
...
To build Cybercash (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the cybercash repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cybercash/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/cybercash-crypto/cybercash
...
For example:
```bash
URL=https://github.com/crowning-/cybercash.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit cybercash=${COMMIT} --url cybercash=${URL} ../Cybercash/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit cybercash=${COMMIT} --url cybercash=${URL} ../Cybercash/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit cybercash=${COMMIT} --url cybercash=${URL} ../Cybercash/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/cybercash-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cybercash-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/cybercash-build.assert
```
...
[cybercash/gitian.sigs](https://github.com/cybercash-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
