...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cybercash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cybercash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cybercash features */
        {"cybercash", "masternode", &masternode, true, true, false},
        {"cybercash", "listmasternodes", &listmasternodes, true, true, false},
        {"cybercash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cybercash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cybercash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cybercash", "masternodedebug", &masternodedebug, true, true, false},
        {"cybercash", "startmasternode", &startmasternode, true, true, false},
        {"cybercash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cybercash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cybercash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cybercash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cybercash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cybercash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cybercash", "mnbudget", &mnbudget, true, true, false},
        {"cybercash", "preparebudget", &preparebudget, true, true, false},
        {"cybercash", "submitbudget", &submitbudget, true, true, false},
        {"cybercash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cybercash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cybercash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cybercash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cybercash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cybercash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cybercash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cybercash", "checkbudgets", &checkbudgets, true, true, false},
        {"cybercash", "mnsync", &mnsync, true, true, false},
        {"cybercash", "spork", &spork, true, true, false},
        {"cybercash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cybercash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cybercashd, or the -server option to cybercash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cybercash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5519/\n";
}
