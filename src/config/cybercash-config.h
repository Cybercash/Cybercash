/* src/config/cybercash-config.h.  Generated from cybercash-config.h.in by configure.  */
/* src/config/cybercash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CYBERCASH_CONFIG_H

#define CYBERCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cybercash.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cybercash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cybercash Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cybercash"
